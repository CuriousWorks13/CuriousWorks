...
const CW_COURSES = [
  // --- Science ---
  {
    ...
    field: 'Science',
    icon: 'leaf',
    description: 'Explore cells, genetics, and ecosystems through interactive models and visual demonstrations that reveal how living things work.',
    ageRange: 'Grades 6–8',
    level: 'Beginner',
  ...
  },
  {
    ...
    field: 'Science',
    icon: 'flask',
    description: 'An introduction to atoms, molecules, and chemical reactions, brought to life through interactive simulations and visual demonstrations.',
    ageRange: 'Grades 7–8',
    level: 'Intermediate',
    duration: '4 weeks · 1 hr/session · Online',
  ...
  },
  {
    ...
    field: 'Science',
    icon: 'atom',
    description: 'Investigate motion, forces, and energy through interactive simulations and demonstrations that make the rules of the physical world click.',
    ageRange: 'Grades 7–8',
    level: 'Intermediate',
    duration: '4 weeks · 1 hr/session · Online',
  ...
  },
  {
    ...
    field: 'Science',
    icon: 'heart',
    description: 'Explore how the heart, brain, lungs, and muscles work together, through interactive models, diagrams, and visual demonstrations.',
    ageRange: 'Grades 6–8',
    level: 'Beginner',
    duration: '4 weeks · 1 hr/session · Online',
